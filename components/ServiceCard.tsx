...
export default function ServiceCard({ service, delay = 0 }: { service: Service; delay?: number }) {
  return (
    <Reveal
      delay={delay}
      className="group relative flex flex-col gap-4 rounded-2xl border border-ink/8 bg-white p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-gold/40 hover:shadow-[0_20px_45px_-20px_rgba(16,42,67,0.25)]"
    >
